...
import {getUserData} from '@/auth/utils.js';
  export default {
    ...
    methods: {
      ...
      async validate () {
        this.pago_pasivo.inquilino_nombre=this.inquilino.name;
        this.pago_pasivo.inquilino_id=this.inquilino._id;
        this.pago_pasivo.diainicio=this.inquilino.diainicio;
     ...
     watch:{
      inquilino: {
        handler(newValue, oldValue) {
          this.pago_pasivo.detalles=`Devolucion de garantia a ${this.inquilino.name}.`;
        },
        deep: true
    },  
    },
    mounted(){
      //this.pago_pasivo.detalles=`${this.codificacion}`;
